...
public class SemiBill extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_semi_bill);

        // Initialize Header Box
        TextView headerTextView = findViewById(R.id.header_text_view);
        headerTextView.setText("SINH VIÊN THIẾU TIỀN DỊCH VỤ");

        // Initialize List Title Box
        TextView listTitleTextView = findViewById(R.id.list_title_text_view);
        listTitleTextView.setText("Danh sách sinh viên thiếu tiền dịch vụ");
